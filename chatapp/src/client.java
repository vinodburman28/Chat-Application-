...
public class client implements ActionListener {
    ...
    client()
    {
        ...
        // adding profile icon in header layout

        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icon/Nobitaa.png"));   // profile image
        Image i5=i4.getImage().getScaledInstance(40,55,Image.SCALE_DEFAULT);    //  set the image size and make it default here
        ImageIcon i6=new ImageIcon(i5);
        JLabel profile =new JLabel(i6);
        profile.setBounds(40,7,40,55);
        ...
        JLabel name = new JLabel("Nobitaa");
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(0,128,255));                 //set the background color to green of message
